...
frame2=Frame(root)
frame3=Frame(root)
label1=Label(root,text="Select An Option to Login")
label1.config(font=('Italic',16,'bold'), justify=CENTER, background="Orange",fg="Yellow", anchor="center")
label1.pack(fill=X)


button1=Button(f,text="Admin Login",font=('Italic',16,'bold'), background="Brown", fg="White", command=admin_login, width=15)
button1.pack(fill=X)
button2=Button(f,text="Station Login", font=('Italic',16,'bold'),background="Brown", fg="white", command=Station_login, width=8)
button2.pack(fill=X)
button3=Button(f,text="Public Login", font=('Italic',16,'bold'),background="Brown", fg="white", command=Public_login, width=8)
button3.pack(fill=X)
button4=Button(f,text="Home Page",font=('Italic',16,'bold'), background="Brown", fg="White", width=8, command=Home1)
button4.pack(fill=X)
